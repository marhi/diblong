...
> = {
  sl: {
    ...
    metaTitle: 'Trgovina | Digo',
    metaDescription: 'Brskajte po premium izdelkih Digo z večjezičnimi SEO povezavami.',
  },
  en: {
    kicker: 'Shop',
    title: 'The Digo line',
    ...
    metaTitle: 'Shop | Digo',
    metaDescription: 'Browse premium Digo products with multilingual SEO.',
  },
  hr: {
    kicker: 'Trgovina',
    title: 'Digo linija',
    ...
    metaTitle: 'Trgovina | Digo',
    metaDescription: 'Pregledajte premium Digo proizvode s višejezičnim SEO-om.',
  },
};
